...
```
$config = [
    'secret_id' => '954a3c***************db8cf0ed5',
    'secret_key' => '1e7cf9b4c***************02d0bb18',
    'business_id' => '91d601***************5fada0344d8',
    'callback_url' => 'https://xxx.xxx.com/xxxx',
];
```
...
// url方式
print_r(\Karlhsu\Yidun\Factory\Factory::image($config)->check($params));
...
$params = [
    ...
    "callback_url" => "www.*.com/yidun/callback" // 自定义回调地址，异步调用时可传，默认读配置
];
// 同步调用
