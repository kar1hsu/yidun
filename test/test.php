...
$config = [
    'secret_id' => '954a3***************cf0ed5',
    'secret_key' => '1e7cf***************0bb18',
    // 'business_id' => '91d6***************a0344d8', // 文本
    // 'business_id' => 'db5a4***************4952356226', // 图片
    // 'business_id' => '8141***************967d94eda2', // 点播音频
    // 'business_id' => 'fce289***************0aa35e93', // 直播音频
    'callback_url' => 'https://xxx.xxx.com/xxxx', // 异步回调地址
];


// 文本
/*print_r(\Karlhsu\Yidun\Factory\Factory::text($config)->check([
    'dataId' => '123-456-789',
    'content' => '很久很久',
    // 'dataType' => '1',
    // 'ip' => '123.115.77.137',
    ...
    // 'callback' => 'ebfcad1c-dba1-490c'
]));*/

// 图片
// $images = array();
// $images[] = array(// type=1表示传图片url检查
...
// );
// $images[] = array(// type=1表示传图片url检查
//     "name" => "https://peique-1318387147.cos.accelerate.myqcloud.com/dev/public/2024/02/18/wOqOkvU1ZW9KtfEwkQtjqT8Hu3jzeBEyXSZeIS47_thumb.png",
//     "type" => 1,
//     "data" => "https://peique-1318387147.cos.accelerate.myqcloud.com/dev/public/2024/02/18/wOqOkvU1ZW9KtfEwkQtjqT8Hu3jzeBEyXSZeIS47_thumb.png",
// );
// $images[] = array( // type=2表示传图片base64编码进行检查
...
// );
//
// print_r(\Karlhsu\Yidun\Factory\Factory::image($config)->checkBase64($params));

// 音频
// $params = [
//     "dataCheckType" => 0, // 检测类型，默认0-url，1-语音内容base64
//     "url" => "https://peique-1318387147.cos.ap-guangzhou.myqcloud.com/dev/user_audio/2024/07/29/m8BoQvz30SjUb0xyr8a4Wm1LTTDD4krU1g2hEyAX.m4a"
//     "callback"=>[
//         "type"=>"audio",
//     ],
//     "callback_url"=>"http://xxx.xxx.com/xxxx"
// ];
// print_r(\Karlhsu\Yidun\Factory\Factory::audio($config)->check($params));
// 异步调用
// print_r(\Karlhsu\Yidun\Factory\Factory::audio($config)->submit($params));
...
//     "callback_url"=>"http://xxx.xxx.com/xxxx"
// );
// print_r(\Karlhsu\Yidun\Factory\Factory::video($config)->submit($params));